...
/**
 * @brief counts the number of items in a file based on the number of newline characters
 * 	  present. 
 *
 * @note    this function assumes that the input file is formatted correctly.
 *
 * @return  number of items a file contains.
 * @param   char line is used by the fgets function to read line by line
 * @param   FILE* file is the file to be read
 */
